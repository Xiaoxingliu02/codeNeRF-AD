...
parser.add_argument('--idname', type=str, default='angle',
...
parser.add_argument('--frame_num', type=int,
                    default=100000, help='image number')
args = parser.parse_args()
start_id = 0
end_id = args.frame_num

id_dir = os.path.join('/fs1/home/tjuvis_2022/lxx/DFRF-main/data_util/dataset/', args.idname)
#print(os.path.join(id_dir, 'ori_imgs'))
...
#set the fix focal for all vids
arg_focal = 1300
