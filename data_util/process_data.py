...
parser.add_argument('--id', type=str,
                    default='angle', help='identity of target person')
parser.add_argument('--step', type=int,
                    default=0, help='step for running')

args = parser.parse_args()
id = args.id
vid_file = os.path.join('/fs1/home/tjuvis_2022/lxx/dataset/', 'vids', id+'.mp4')
...
if running_step == 0:
    ...
    extract_ds_cmd = 'python /fs1/home/tjuvis_2022/lxx/data_util/deepspeech_features/extract_ds_features.py --input=' + id_dir
...
if running_step == 3:
    ...
    face_parsing_cmd = 'python /fs1/home/tjuvis_2022/lxx/data_util/face_parsing/test.py --respath=' + \
...
if running_step == 5:
    ...
    whi_img = cv2.imread(os.path.join(id_dir, 'whi.png'))
    ...
    def dilate_head_part(img, bc_img, parse_img, kernel_size=11, verbose=False):
        ...
        return dialte_head_torso_img, new_neck_part,torso_part
    ...
    for i in valid_img_ids:
        ...
        neck_torso_img, new_neck_part,torso_part = dilate_head_part(torso_img_newbc, bc_img, parsing_img)
        ...
        #img[bc_part] = parsing_img[bc_part]
        #img[new_neck_part] = whi_img[new_neck_part]
        #img[torso_part] = whi_img[torso_part]
        #cv2.imwrite(os.path.join(whi_head_imgs_dir, str(i) + '.jpg'), img)

    running_step+=1
# Step 6: estimate head pose
if running_step == 6:
    print('--- Estimate Head Pose ---')
    est_pose_cmd = 'python /fs1/home/tjuvis_2022/lxx/data_util/face_tracking/face_tracker.py --idname=' + \
...
# Obama's last segment was used as the test set.
# May's first segment was used as the test set.
if running_step == 7:
    ...
    train_ids = torch.arange(0, train_val_split) # Obama
