...
class BaseOptions():
    ...
    def initialize(self):
        self._parser.add_argument('--data_dir', type=str,default='/fs1/home/tjuvis_2022/lxx/DFRF-main/data_util/dataset/Shaheen/', help='path to dataset')
        ...
        self._parser.add_argument('--images_folder', type=str, default='crop/', help='images folder')
        ...
        self._parser.add_argument('--cond_nc', type=int, default=5, help='# of conditions')
        self._parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self._parser.add_argument('--name', type=str, default='experiment_Shaheen', help='name of the experiment. It decides where to store samples and models')
